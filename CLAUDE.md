...
**Tipos de solicitud visibles en el dropdown de creación:** `PAGO A PROVEEDORES`, `POLIZAS Y SEGUROS`, `Recibo por Honorarios` y `Liberalidad`. Los tipos `A RENDIR`, `CAJA CHICA` y `REEMBOLSO` están ocultos porque tienen módulos propios.
