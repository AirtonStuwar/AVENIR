...
- **Retención 5% fija y automática:** al crear, se guarda `porcentaje_retencion = 5` y `monto_retencion = monto bruto × 5%` directamente (sin pasar por el evaluador, a diferencia de RxH donde el evaluador elige 0/3/8%). El total = subtotal − retención (mismo patrón que RxH), sin IGV.
